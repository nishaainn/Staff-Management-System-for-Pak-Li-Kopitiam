                  ...
                  <div class="card-body">
                    ...
                    <form class="form-sample" action = "../../process/update.php" method = "POST">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Time Clock-Out</label>
                            <div class="col-sm-9">
                              <?php
                                $currentTime = date('H:i:s');
                                echo '<input style ="color:#343a40;" class="form-control" type="text" name="clockOut" value="' . $currentTime . '" readonly/>';
                              ?>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="col-12 d-flex justify-content-end">
                        <input type="hidden" name="purpose" value="updateClockOut" required>
                          <button type="submit"
