...
<div class="mt-4">
    ...
    ?>
        <div class="row text-secondary-d2 py-25">
            ...
            <div class="d-none d-sm-block col-4 col-sm-2"><?php echo $row['totalDay']; ?></div>
            <div class="d-none d-sm-block col-sm-2"><?php echo $row['status']; ?></div>
            <div class="col-2"><?php echo $row['totalSalary']; ?></div>
        </div>
    <?php
    }
    ?>
...
<div class="col-5">
<span class="text-150 text-success-d3 opacity-2"><?php echo $row['totalSalary']; ?></span>
</div>
</div>
</div>
</div>
